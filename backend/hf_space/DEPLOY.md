...
| 2.9 | GPU time per call | **30 s** (`CONDDIFF_GPU_DURATION`; checked as 45 s) | A formula based on steps; 60 s; 10 s | Safe for cold starts on day one. Tighten to ~1.5 × the measured cold-call time, and keep it ≤ 80. A typo falls back to 30. |
